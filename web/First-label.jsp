        ...
        <form action="/replace_First_label" method="post">
          ...
          <textarea name="Reference-mark" rows="8" cols="130" style="" placeholder="1、搅拌箱；2、电机；3、固定壳；4、转轴；41、外壳；42、花键通道；43、内腔；44、滑动腔；5、花键轴；6、气缸；7、搅拌机构；71、滑轴；72、搅拌轴；73、螺旋桨；74、振动装置。"></textarea>
            ...
            <div style="text-align: center; margin-top: -50px">
                <label><input name="Fruit" type="radio" value="Youxu" checked class="filed"/><font color="red">正向序列</font></label>
                <label><input name="Fruit" type="radio" value="WuXu" class="filed"/><font color="red">反向序列</font></label>
            </div>
...
❤❤❤"></textarea>
        ...
        <form action="${pageContext.request.contextPath}/First-label.jsp" class="l3">
